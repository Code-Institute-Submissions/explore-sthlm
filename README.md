...
-   As a user I want to easily find a way to contact the site owner wherever I am on the site.
...
#### Navigation bar 
- Clicking on the logo transports the user back to the start if on another part of the site
- Clicking on the house-icon transports the user back to the start when on another part of the site
...
- Google Maps is working correctly, each link in the menu makes the Google Map narrow in on the selected neighborhood and a div  fades in below map with information and photos about the selected neighborhood. 
...
- Typing in wrong email address message will pop up that email is not correct (not working)
#### Footer
...
### Own Reflections 
I struggled a lot in this module with learning and understanding Javascript, leading to a lack of time in the end for the project. So there's still some code I would have liked to add to the project but due to lack of knowledge in Js I am still happy I made the code I have in there work properly. 
I am sure there are easier ways to write the Js code which I will learn over time and return to this site to rewrite it but considering the struggle I've had and still have I am proud I got this much to work. 
I have searched a lot of forums and websites to find information and better understand writing Javascript code and I hope I have managed to gather all the code and media I have used for helping me understanding writing the code better. 
